...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bhcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bhcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bhcoin transaction") + "\n" +
              "  bhcoin-tx [options] -create [commands]   " + _("Create hex-encoded bhcoin transaction") + "\n" +
              "\n";
